        ...
        <CRow>
            <CCol lg={12} sm={12}>
                <CCard className='mb-3 border-top-success border-top-3'>
                    <CCardHeader>
                        <strong className="mt-2">Client Support <span className='float-end'>Total Left Clients : {result1.filter((list) => list.username === username && list.plan === false).length}</span></strong>
                    </CCardHeader>
                    <CCardBody>
