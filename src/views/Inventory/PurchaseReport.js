            ...
            <CTable className='mt-3 ' align="middle" bordered style={{ borderColor: "#0B5345" }} hover responsive>
                <CTableHead style={{ backgroundColor: "#0B5345", color: "white" }} >
                    ...
                    <CTableHeaderCell>Sr.No</CTableHeaderCell>
                        ...
                        <CTableHeaderCell>Balance Stock</CTableHeaderCell>
                        <CTableHeaderCell>Consumption Qty</CTableHeaderCell>
                ...
                <CTableBody>
                    ...
                    {result1.map((item, index) => (
                        <CTableRow key={index}>
                            ...
                            <CTableDataCell>{item.Opening_Stock}</CTableDataCell>
                            <CTableDataCell>{item.Purchase_Stock}</CTableDataCell>
                            <CTableDataCell>{item.Balance_Stock}</CTableDataCell>
                            <CTableDataCell>{item.Consumption_Quantity}</CTableDataCell>
                            <CTableDataCell>{item.Closing_Stock}</CTableDataCell>                        
                        </CTableRow>
                    ))}
                </CTableBody>
            </CTable>
