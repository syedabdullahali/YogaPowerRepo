            ...
            <CCol lg={12} sm={12}>
                <CCard className="mb-3 border-success">
                    <CCardHeader style={{ backgroundColor: '#0B5345', color: 'white' }}>
                        <CCardTitle className="mt-2">All Classes Report</CCardTitle>
                    </CCardHeader>
                    <CCardBody>
                        ...
                        <CTable className='mt-3' align="middle" bordered style={{ borderColor: "#0B5345" }} hover responsive>
                            <CTableHead style={{ backgroundColor: "#0B5345", color: "white" }} >
                                <CTableRow >
                                    ...
                                    <CTableHeaderCell>Batch/PT Classes</CTableHeaderCell>
                                    <CTableHeaderCell>Classes Timing</CTableHeaderCell>
                                    <CTableHeaderCell>Assigned No of Class</CTableHeaderCell>
